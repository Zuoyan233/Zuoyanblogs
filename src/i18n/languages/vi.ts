...
export const vi: Translation = {
	...
	[Key.devicesSubtitle]: "İşte günlük hayatımda kullandığım cihazlar",
	...
	[Key.rssBenefit1]:
	"En son web sitesi içeriğini zamanında ve sorunsuz bir şekilde alın manuel olarak ziyaret edin",
	[Key.rssBenefit2]: "Birden fazla web sitesine abonelikleri tek bir yerden yönetin",
	...
	[Key.rssCopyFailed]: "Kopyalama başarısız oldu, lütfen bağlantıyı manuel olarak kopyalayın",
	...
	"Atom (Atom Yayınlama Biçimi), akışları ve öğelerini tanımlamak için XML tabanlı bir standarttır. Atom ile şunları yapabilirsiniz:",
	[Key.atomBenefit1]:
	"Manuel olarak ziyaret etmeden en son web sitesi içeriğine zamanında ulaşın",
	[Key.atomBenefit2]: "Birden fazla web sitesine abonelikleri tek bir yerden yönetin",
	[Key.atomBenefit3]: "Önemli güncellemeleri ve makaleleri kaçırmayın",
	[Key.atomBenefit4]: "Reklamsız ve temiz bir web sitesinin keyfini çıkarın okuma deneyimi",
	[Key.atomHowToUse]:
	...
	[Key.atomCopyFailed]: "Kopyalama başarısız, lütfen bağlantıyı manuel olarak kopyalayın",

	// Duvar kağıdı modu
	[Key.wallpaperBanner]: "Banner Modu",
	...
	[Key.passwordDecryptFailed]: "Şifre çözme başarısız oldu, lütfen şifreyi kontrol edin",
	[Key.passwordDecryptRetry]: "Şifre çözme başarısız oldu, lütfen tekrar deneyin",
	...
	[Key.autoSyntaxHighlightFailed]: "Otomatik sözdizimi vurgulama da başarısız oldu:",
