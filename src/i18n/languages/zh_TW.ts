...
export const zh_TW: Translation = {
	...
	[Key.musicPlayerLocateCurrent]: "定位到當前歌曲",
	...
	[Key.wallpaperFullscreenBanner]: "全螢幕橫幅",
	...
	[Key.navbarTransparentSemifull]: "動態透明",
	...
	// 新增社群軟體好友
	[Key.copyAccount]: "複製帳號",
	[Key.copyAccountSuccess]: "已複製到剪貼簿",
	[Key.openAppAdd]: "打開App添加",
	...
	[Key.weatherDefaultLocationHint]:
		"因拒絕隱私協議，正在使用已設定的預設位置定位天氣",
	[Key.weatherDefaultLocationConfirm]: "確定",
	[Key.weatherLoading]: "正在載入天氣...",
	[Key.weatherLoadFailed]: "載入失敗",
	[Key.weatherRetry]: "重試",
	[Key.weatherSearchPlaceholder]: "搜尋城市...",
	[Key.weatherHumidity]: "濕度",
	[Key.weatherWind]: "風速",
	[Key.weatherFeelsLike]: "體感溫度",
	[Key.weatherUV]: "紫外線指數",
	[Key.weatherVisibility]: "能見度",
	[Key.weatherForecast]: "天氣預報",
	[Key.weatherToday]: "今天",
	[Key.weatherHigh]: "最高",
	[Key.weatherLow]: "最低",
	...
	[Key.weatherKmh]: "km/h",
	[Key.weatherMph]: "mph",
	[Key.weatherChangeLocation]: "切換地區",
	[Key.weatherDetectLocation]: "自動定位",

	// 天氣條件
	[Key.weatherCondSunny]: "晴",
	[Key.weatherCondPartlyCloudy]: "多雲",
	[Key.weatherCondCloudy]: "陰",
	[Key.weatherCondFog]: "霧",
	[Key.weatherCondDrizzle]: "毛毛雨",
	[Key.weatherCondRain]: "雨",
	[Key.weatherCondHeavyRain]: "大雨",
	[Key.weatherCondSnow]: "雪",
	[Key.weatherCondHeavySnow]: "大雪",
	[Key.weatherCondSleet]: "雨夾雪",
	[Key.weatherCondThunderstorm]: "雷暴",
	[Key.weatherCondHail]: "冰雹",
	[Key.weatherCondDust]: "沙塵",

	// Cookie 隱私提示
	[Key.cookieConsentTitle]: "我們重視您的隱私",
	[Key.cookieConsentDescription]:
		"BrightMoon 使用 Cookie 來存儲和訪問裝置識別碼等數據，以提供、維護和改進我們的服務和廣告。您可以選擇「接受」以同意這些用途，或點擊「全部拒絕」來拒絕非必要的 Cookie。",
	[Key.cookieConsentIpInfo]: "正在獲取您的位置資訊...",
	[Key.cookieConsentIpTimeout]: "位置資訊獲取逾時，請稍後再試",
	[Key.cookieConsentAccept]: "我接受",
	[Key.cookieConsentReject]: "全部拒絕",
	...
	[Key.breadcrumbExpand]: "展開麵包屑導航",
	[Key.breadcrumbCollapse]: "收起麵包屑導航",
