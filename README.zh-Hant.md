...
Zuoyanblogs博客項目是基於 <a href="https://github.com/matsuzaka-yuki/mizuki" target="_blank">Mizuki</a> 主題框架開源項目二次魔改，它是一個現代化、功能豐富的靜態博客模板，基於 <a href="https://astro.build/" target="_blank">Astro</a> 構建，具有先進的功能和精美的設計。
...
- 添加多語言國際翻譯組件：
 1. 魔改mobile-navbar樣式表適配translate面板樣式。
 2. 添加六個國家的站點語言文本，未來站點更新並同步更新站點語言文本。
- 修改日歷樣式，並魔改最舒服的外觀：
 1. 更改左右切換的icon。
 2. 調整文章發布的底部小圓點的位置。
 3. 調整右上角同天發布多文章的數字大小。
...
⭐ 如有問題或建議，請提交 [Issue](https://github.com/Zuoyan233/Zuoyanblogs/issues) 或 [Pull Request](https://github.com/Zuoyan233/Zuoyanblogs/pulls)。另外，您也可以透過 [我的網站反饋頁面](https://www.zuoyanblogs.xyz/feedback/) 與我們聯繫。您覺得這個項目有幫助，請考慮給它一個星標！