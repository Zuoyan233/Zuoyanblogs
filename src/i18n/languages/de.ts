...
export const de: Translation = {
	...
	[Key.musicPlayerLocateCurrent]: "Zum aktuellen Titel",
	...
	[Key.siteStatsAm]: "AM",
	[Key.siteStatsPm]: "PM",
	[Key.siteStatsSeason]: "Jahreszeit",
	[Key.siteStatsSeasonSpring]: "Frühling",
	[Key.siteStatsSeasonSummer]: "Sommer",
	[Key.siteStatsSeasonAutumn]: "Herbst",
	[Key.siteStatsSeasonWinter]: "Winter",

	// Kalender-Komponente
	[Key.calendarPrevMonth]: "Vorheriger Monat",
	[Key.calendarNextMonth]: "Nächster Monat",
	[Key.calendarBackToToday]: "Zurück zu heute",
	...
	[Key.weatherForecast]: "Wettervorhersage",
	...
	[Key.weatherCondDust]: "Staub",

	// Cookie-Einwilligung
	[Key.cookieConsentTitle]: "Wir respektieren Ihre Privatsphäre",
