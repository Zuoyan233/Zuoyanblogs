...
export const zh_CN: Translation = {
	...
	[Key.musicPlayerMute]: "静音",
	[Key.musicPlayerUnmute]: "取消静音",
	...
	[Key.weatherDefaultLocationHint]:
		"因拒绝隐私协议，正在使用已设定的默认位置定位天气",
	[Key.weatherDefaultLocationConfirm]: "确定",
	[Key.weatherLoading]: "正在加载天气...",
	[Key.weatherLoadFailed]: "加载失败",
	[Key.weatherRetry]: "重试",
	[Key.weatherSearchPlaceholder]: "搜索城市...",
	...
	[Key.weatherKmh]: "km/h",
	[Key.weatherMph]: "mph",
	[Key.weatherChangeLocation]: "切换地区",
	[Key.weatherDetectLocation]: "自动定位",

	// 天气条件
	[Key.weatherCondSunny]: "晴",
	[Key.weatherCondPartlyCloudy]: "多云",
	[Key.weatherCondCloudy]: "阴",
	[Key.weatherCondFog]: "雾",
	...
	[Key.cookieConsentIpTimeout]: "位置信息获取超时，请稍后再试",
	...
	// 版本更新检测
	[Key.versionCheck]: "检查更新",
	[Key.versionLatest]: "已是最新版本",
	[Key.versionNewVersion]: "发现新版本",
	[Key.versionChecking]: "检查中...",
	[Key.versionCheckError]: "检查失败",
