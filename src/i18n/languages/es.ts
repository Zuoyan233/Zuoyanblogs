...
export const es: Translation = {
	...
	[Key.atomBenefit1]:
	"Obtener el contenido más reciente del sitio web a tiempo sin necesidad de visitarlo manualmente",
	[Key.atomBenefit2]: "Administrar suscripciones a varios sitios web en un solo lugar",
	[Key.atomBenefit3]: "Evita perderte actualizaciones y artículos importantes",
	[Key.atomBenefit4]: "Disfruta de una experiencia de lectura limpia y sin publicidad",
	[Key.atomHowToUse]:
	...
	[Key.atomCopyFailed]: "Error al copiar, por favor, copia el enlace manualmente",
	...
	[Key.passwordDecryptFailed]: "Error en el descifrado, por favor, revise la contraseña",
	[Key.passwordDecryptRetry]: "Error en el descifrado, por favor, inténtelo de nuevo",
	...
	[Key.autoSyntaxHighlightFailed]: "El resaltado de sintaxis automático también falló:",
